...
public function downloadRegZip(Request $request)
    {
        ...
        try {
            $basePath = public_path("storage/reg_certificates/{$sess_yr}");
            ...
            // ===============================
            // CASE 1: SINGLE INSTITUTE PDF
            // ===============================
            if (!empty($inst_code)) {
                $filePath = "{$basePath}/PHARM-REG_CERTIFICATE-{$inst_code}-{$sess_yr}.pdf";
                ...
                return Zip::create(
                    "REG-CERTIFICATE-PHARM-{$inst_code}-{$sess_yr}.zip",
                    [$filePath]
                );
            }
            ...
            return Zip::create(
                "REG-CERTIFICATE-PHARM-{$sess_yr}.zip",
                $files
            );

        } catch (\Exception $e) {
            Log::error('Error generating registration zip: ' . $e->getMessage());
