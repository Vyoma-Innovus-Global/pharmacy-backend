...
Route::prefix('student')->middleware('authenticate')->group(function () {
    ...
    Route::get('/download-form/{from_num}', [StudentController::class, 'downloadForm']);
    Route::get('/student-details/{from_num}', [StudentController::class, 'studentdetails']);
    Route::post('/student-review-subjects', [StudentController::class, 'getStudentReviewSubject']);
    Route::post('/student-review-apply', [StudentController::class, 'applyForReview']);
...
Route::prefix('enrollment')->middleware('authenticate')->group(function () {
    ...
    Route::post('/enroll-payment', [PaymentController::class, 'payment']);
    ...
    Route::get('/enrollment-receipt', [EnrollmentController::class, 'enrollmentReceipt']);
    Route::post('/submit', [EnrollmentController::class, 'enrollmentsubmit']);
    Route::get('/enrollment-download', [EnrollmentController::class, 'enrollmentDownload']);
...
Route::prefix('examinations')->middleware('authenticate')->group(function () {
    Route::get('/admit-card-download', [ExaminationController::class, 'downloadAdmitCard']);
    Route::get('/admit-card-download-inbulk', [ExaminationController::class, 'downloadAdmitCardInbulk']);
    ...
    Route::get('/hall-sticker-download', [ExaminationController::class, 'hallStickerDownload']);
    Route::post('/descriptive-roll', [ExaminationController::class, 'descriptiveRoll']);
    Route::get('/descriptive-roll-download', [ExaminationController::class, 'descriptiveRollDownload']);
    Route::post('/top-sheet-count', [ExaminationController::class, 'topSheetCount']);
    Route::get('/top-sheet-download', [ExaminationController::class, 'topSheetDownload']);
...
Route::prefix('reports')->middleware('authenticate')->group(function () {
