...
class StudentController extends Controller
{
    ...
    public function studentdetails($form_num)
    {
		...
		$imagePath = "public/{$student->s_photo}";  // Full path to the image
		$valid_photo	=	true;
		 
		// Check if the file exists and is a valid image
		 
		if($student->s_photo==null) {
			$valid_photo	=	false;
		}  
		$studentData['valid_photo']	=	$valid_photo;
        ...
        try {
            ...
            elseif($certificate_type == 'duplicate'){
                ...
                foreach ($groupedByInstitute as $inst_code => $studentGroup) {
                    ...
                    // Step 6: Generate PDF
                    $pdf = PDF::loadView('registration-certificate', ['data' => $certInfo])
