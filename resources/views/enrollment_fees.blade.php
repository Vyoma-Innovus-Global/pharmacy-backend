...
<head>
    ...
    <title> {{ $data->enrl_part_sem }} Enrollment Fees Money-receipt ({{ $data->enrl_type }}-{{ $data->enrl_year }})</title>
    <style>
        body {
...
<body>
    ...
    <div class="main-section" style="border:1px solid black;">
        <div>
            <h3 style="text-align:center;"> Payment Of Examination Fees ({{ $data->enrl_part_sem }} -<small>{{ $data->enrl_year }}</small>)</h3>
